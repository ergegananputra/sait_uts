...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2024 at 11:56 AM
...
('svpl_001', 'database', 2),
('svpl_002', 'kecerdasan artificia', 2),
...
--
ALTER TABLE `perkuliahan`
  MODIFY `id_perkuliahan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `perkuliahan`
  ADD CONSTRAINT `FK_mahasiswa` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_matakuliah` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`) ON DELETE CASCADE;
COMMIT;
